...
// Busca a tela
$result = $telaController->getById($id);
if (!$result['success']) {
    header('Location: telas.php');
    exit;
}
...
<style>
/* Estilos modernos para a página de edição de telas */
.modern-card {
        ...
        <div class="modern-card">
            <div class="modern-card-header">
                <h5 class="mb-0">
                    ...
                    Editar Tela: <?= htmlspecialchars($tela['nome']) ?>
                </h5>
            </div>
            <div class="card-body p-4">
                <form id="formEditarTela">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control modern-form-control" id="nome" name="nome" 
                                       value="<?= htmlspecialchars($tela['nome']) ?>" required maxlength="100">
                                <div class="form-text">Máximo 100 caracteres</div>
                            </div>
                            
                            <div class="mb-3">
                                <label for="descricao" class="form-label fw-semibold">Descrição</label>
                                <textarea class="form-control modern-form-control" id="descricao" name="descricao" rows="3" 
                                          placeholder="Descrição opcional da tela"><?= htmlspecialchars($tela['descricao'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select modern-form-select" id="resolucao" name="resolucao">
                                    <option value="1280x720" <?= $tela['resolucao'] === '1280x720' ? 'selected' : '' ?>>HD - 1280x720</option>
                                    <option value="1920x1080" <?= $tela['resolucao'] === '1920x1080' ? 'selected' : '' ?>>Full HD - 1920x1080</option>
                                    <option value="3840x2160" <?= $tela['resolucao'] === '3840x2160' ? 'selected' : '' ?>>4K - 3840x2160</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control modern-form-control" id="localizacao" name="localizacao" 
                                       value="<?= htmlspecialchars($tela['localizacao'] ?? '') ?>"
                                       placeholder="Ex: Recepção, Sala de Espera, Hall Principal">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-check form-switch modern-form-switch">
                                        <input class="form-check-input" type="checkbox" id="com_moldura" name="com_moldura" value="1" <?= $tela['com_moldura'] ? 'checked' : '' ?>>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="modern-alert modern-alert-info">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <strong>Hash Único:</strong><br>
                                        <code class="bg-white p-1 rounded"><?= $tela['hash_unico'] ?></code>
                                    </div>
                                    <div class="col-md-4">
                                        <strong>Status:</strong><br>
                                        <span class="modern-badge modern-badge-<?= $tela['status'] === 'online' ? 'success' : 'secondary' ?>">
                                            <?= ucfirst($tela['status']) ?>
                                        </span>
                                    </div>
                                    <div class="col-md-4">
                                        <strong>Data de Criação:</strong><br>
                                        <?= date('d/m/Y H:i', strtotime($tela['data_criacao'])) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modern-card">
            ...
            <div class="card-body p-4">
                <div class="modern-preview-container text-center">
                    <div id="telaPreview" class="preview-screen border rounded bg-dark text-white position-relative" style="max-width: 600px; margin: 0 auto; aspect-ratio: 16/9; overflow: hidden;">
                        ...
                        <div id="previewSemMoldura" class="w-100 h-100 d-flex flex-column justify-content-center align-items-center p-3">
                            <div class="text-center">
                                ...
                                <h4 class="mt-3 mb-2" id="previewNome"><?= htmlspecialchars($tela['nome']) ?></h4>
                                <p class="mb-1 text-info" id="previewResolucao"><?= $tela['resolucao'] ?></p>
                                <small class="text-muted" id="previewLocalizacao"><?= htmlspecialchars($tela['localizacao'] ?? 'Localização não informada') ?></small>
                            ...
                            <div class="bg-primary d-flex flex-column justify-content-between p-2" style="grid-area: 1 / 1 / 2 / 2;">
                                <div class="text-center">
                                    ...
                                    <div class="text-start">
                                        <small class="d-block mb-1">📍 <span id="previewLocalizacaoMoldura"><?= htmlspecialchars($tela['localizacao'] ?? 'Local') ?></span></small>
                    ...
                    <div class="mt-3">
                        <small class="text-muted d-block mb-2" id="previewMoldura"><?= $tela['com_moldura'] ? 'Com moldura (sidebar com informações)' : 'Sem moldura (tela cheia)' ?></small>
                        <div class="d-flex justify-content-center gap-2">
                            <span class="modern-badge modern-badge-<?= $tela['com_moldura'] ? 'success' : 'secondary' ?>" id="previewTipo"><?= $tela['com_moldura'] ? 'Com Moldura' : 'Sem Moldura' ?></span>
                            <span class="modern-badge modern-badge-info" id="previewResolucaoBadge">
                                <?php
                                switch($tela['resolucao']) {
                                    case '1280x720': echo 'HD'; break;
                                    case '1920x1080': echo 'Full HD'; break;
                                    case '3840x2160': echo '4K'; break;
                                    default: echo 'Full HD';
                                }
                                ?>
                            </span>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="<?php 
                            ...
                            echo $controller->generatePlayUrl($tela['hash_unico'], $tela['com_moldura']);
                        ?>" class="btn modern-btn modern-btn-success" target="_blank">
                            <i class="bi bi-eye me-2"></i>
                            Visualizar Tela Real
                        </a>
                    </div>
                </div>
            </div>
...
function atualizarPreview() {
    const nome = document.getElementById('nome').value || 'Tela';
...
document.getElementById('formEditarTela').addEventListener('submit', function(e) {
    e.preventDefault();
